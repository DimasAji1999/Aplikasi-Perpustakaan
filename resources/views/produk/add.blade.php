                ...
                <form role="form" accept="{{url('produk/add')}}" method="post">
                  ...
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="penulis" class="form-control" id="exampleInputPassword1" placeholder="Penulis Buku">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="number" name="stock" class="form-control" id="exampleInputPassword1" placeholder="Stock Buku">
                    </div>
                    <div class="form-group">
